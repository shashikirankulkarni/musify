...
class Constants {
	...
	public static $firstNameCharacterOnly="Your first name must be only characters";
	public static $lastNameCharacterOnly="Your last name must be only characters";
